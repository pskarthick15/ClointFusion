...
cf.launch_any_exe_bat_application(r"C:Karthick\ClointFusion\TASK-3\Completed.xlsx")
columns = cf.excel_get_all_header_columns(r"C:Karthick\ClointFusion\TASK-3\Completed.xlsx")
cf.key_press("f5")
...
cf.key_press("ctrl+s")
cf.key_press("Alt+F4")
cf.excel_sort_columns(excel_path=r"C:\Karthick\ClointFusion\TASK-3\Completed.xlsx", sheet_name='Sheet2', firstColumnToBeSorted="Total")
cf.launch_any_exe_bat_application(r"C:\Karthick\ClointFusion\TASK-3\Completed.xlsx")
cf.key_press("right")
cf.key_press("left")
...
cf.browser_write_h("karthickps.clointfusion@gmail.com",User_Visible_Text_Element="To")
...
cf.key_write_enter("Karthick P S")
cf.browser_mouse_click_h("Attach")
cf.browser_mouse_click_h("Browse this computer")
cf.key_write_enter(r'C:\Karthick\ClointFusion\TASK-3\Completed.xlsx')
cf.key_hit_enter()
